...
| **Ignorer les forces du modèle** | Utiliser le mauvais modèle pour la tâche | Voir le [Guide des modèles IA](Guide-Modeles-IA.md) |
...
4. Utilisez le [Linter de prompts](Outils-Linter-Optimizer-Recommender.md) pour vérifier vos prompts
...
**Navigation :** [← Prompt Workshop](Prompt-Workshop.md) &nbsp;|&nbsp; [Guide des modèles IA →](Guide-Modeles-IA.md)
