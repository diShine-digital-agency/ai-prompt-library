...
| Page | Description |
|------|-------------|
| **[Premiers pas](Premiers-Pas.md)** | Installation, configuration et premiers pas |
| **[Référence CLI](Reference-CLI.md)** | Documentation complète de l'interface en ligne de commande |
| **[Prompt Workshop](Prompt-Workshop.md)** | Guide de l'outil interactif dans le navigateur |
| **[Techniques de prompting](Techniques-de-Prompting.md)** | Frameworks, patterns et bonnes pratiques |
| **[Guide des modèles IA](Guide-Modeles-IA.md)** | Comparaison des modèles, tarifs, sélection |
| **[Outils : Linter, Optimiseur, Recommandeur](Outils-Linter-Optimizer-Recommender.md)** | Analyse approfondie des outils qualité |
| **[API et Playground](API-et-Playground.md)** | AI Playground et utilisation programmatique |
| **[Architecture](Architecture.md)** | Architecture technique et référence des modules |
| **[Applications de bureau](Applications-Desktop.md)** | Guide des applications de bureau |
| **[Contribuer](Contribuer.md)** | Comment contribuer : prompts, code et frameworks |
...
- 📋 **Référence des fonctions :** [FUNCTIONS.md](../../FUNCTIONS.md)
...
**Navigation :** [Premiers pas →](Premiers-Pas.md)
