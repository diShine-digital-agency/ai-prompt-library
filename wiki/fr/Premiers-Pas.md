...
Les fichiers de sortie sont dans `dist/`. Consultez la page [Applications de bureau](Applications-Desktop.md) pour les guides spécifiques à chaque plateforme.
...
|---------------|-------------|
| Apprendre toutes les commandes CLI | [Référence CLI](Reference-CLI.md) |
| Explorer l'outil navigateur | [Prompt Workshop](Prompt-Workshop.md) |
| Maîtriser les techniques de prompting | [Techniques de prompting](Techniques-de-Prompting.md) |
| Comparer les modèles IA | [Guide des modèles IA](Guide-Modeles-IA.md) |
| Utiliser les outils qualité | [Outils : Linter, Optimiseur, Recommandeur](Outils-Linter-Optimizer-Recommender.md) |
| Compiler les applications de bureau | [Applications de bureau](Applications-Desktop.md) |
| Contribuer | [Contribuer](Contribuer.md) |

---

**Navigation :** [← Accueil](Accueil.md) &nbsp;|&nbsp; [Référence CLI →](Reference-CLI.md)
