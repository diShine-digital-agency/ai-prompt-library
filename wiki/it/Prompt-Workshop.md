...
Consulta [Strumenti: Linter, Optimizer, Recommender](Strumenti-Linter-Optimizer-Recommender.md) per l'elenco completo delle regole.
...
**Navigazione:** [← Riferimento CLI](Riferimento-CLI.md) &nbsp;|&nbsp; [Tecniche di Prompting →](Tecniche-di-Prompting.md)
