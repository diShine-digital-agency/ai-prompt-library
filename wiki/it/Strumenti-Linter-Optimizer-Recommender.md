...
**Sorgente:** [`src/linter.js`](../../src/linter.js)
...
**Sorgente:** [`src/optimizer.js`](../../src/optimizer.js)
...
**Sorgente:** [`src/recommender.js`](../../src/recommender.js)
...
**Navigazione:** [← Guida Modelli AI](Guida-Modelli-AI.md) &nbsp;|&nbsp; [API e Playground →](API-e-Playground.md)
