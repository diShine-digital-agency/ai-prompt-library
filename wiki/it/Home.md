...
**Versione:** 2.3.0 &nbsp;|&nbsp; **Licenza:** MIT &nbsp;|&nbsp; **Dipendenze:** Zero (solo moduli integrati di Node.js 18+)
...
| Pagina | Descrizione |
|--------|-------------|
| **[Guida Introduttiva](Guida-Introduttiva.md)** | Installazione, configurazione e primi passi |
| **[Riferimento CLI](Riferimento-CLI.md)** | Documentazione completa dell'interfaccia a riga di comando |
| **[Prompt Workshop](Prompt-Workshop.md)** | Guida allo strumento interattivo nel browser |
| **[Tecniche di Prompting](Tecniche-di-Prompting.md)** | Framework, pattern e best practice |
| **[Guida Modelli AI](Guida-Modelli-AI.md)** | Confronto modelli, prezzi, criteri di scelta |
| **[Strumenti: Linter, Optimizer, Recommender](Strumenti-Linter-Optimizer-Recommender.md)** | Approfondimento sugli strumenti di qualità |
| **[API e Playground](API-e-Playground.md)** | AI Playground e utilizzo programmatico |
| **[Architettura](Architettura.md)** | Architettura tecnica e riferimento dei moduli |
| **[App Desktop](App-Desktop.md)** | Guida alle applicazioni desktop |
| **[Contribuire](Contribuire.md)** | Come contribuire con prompt, codice e framework |
...
- 📖 **Guida Utente:** [GUIDE.md](../../GUIDE.md)
- 🔧 **Documentazione Tecnica:** [TECHNICAL.md](../../TECHNICAL.md)
- 📋 **Riferimento Funzioni:** [FUNCTIONS.md](../../FUNCTIONS.md)
- 📝 **Changelog:** [CHANGELOG.md](../../CHANGELOG.md)

---

<p align="center">
Realizzato con ❤️ da <a href="https://dishine.it">diShine Digital Agency</a> — v2.3.0
</p>

---

**Navigazione:** [Guida Introduttiva →](Guida-Introduttiva.md)
