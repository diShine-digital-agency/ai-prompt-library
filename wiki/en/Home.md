...
**Version:** 2.3.0 &nbsp;|&nbsp; **License:** MIT &nbsp;|&nbsp; **Dependencies:** Zero (only Node.js 18+ built-in modules)
...
| **[Prompt Workshop](Prompt-Workshop.md)** | Browser-based interactive tool guide |
| **[Prompting Techniques](Prompting-Techniques.md)** | Frameworks, patterns, and best practices |
| **[AI Models Guide](AI-Models-Guide.md)** | Model comparison, pricing, selection |
| **[Tools: Linter, Optimizer, Recommender](Tools-Linter-Optimizer-Recommender.md)** | Quality tools deep-dive |
| **[API & Playground](API-and-Playground.md)** | AI Playground and programmatic usage |
| **[Architecture](Architecture.md)** | Technical architecture and module reference |
| **[Desktop Apps](Desktop-Apps.md)** | Desktop application guide |
| **[Contributing](Contributing.md)** | How to contribute prompts, code, and frameworks |
...
- 📋 **Functions Reference:** [FUNCTIONS.md](../../FUNCTIONS.md)
- 📝 **Changelog:** [CHANGELOG.md](../../CHANGELOG.md)

---

<p align="center">
Built with ❤️ by <a href="https://dishine.it">diShine Digital Agency</a> — v2.3.0
</p>
