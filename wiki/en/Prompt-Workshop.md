...
See [Tools: Linter, Optimizer, Recommender](Tools-Linter-Optimizer-Recommender.md) for the full rule list.
...
**Navigation:** [← CLI Reference](CLI-Reference.md) &nbsp;|&nbsp; [Prompting Techniques →](Prompting-Techniques.md)
