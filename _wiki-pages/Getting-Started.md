...
Output goes to `dist/`. See the [Desktop Apps](Desktop-Apps) page for platform-specific guides.
...
| Want to... | Go to... |
|-----------|----------|
| Learn all CLI commands | [CLI Reference](CLI-Reference) |
| Explore the browser tool | [Prompt Workshop](Prompt-Workshop) |
| Master prompting techniques | [Prompting Techniques](Prompting-Techniques) |
| Compare AI models | [AI Models Guide](AI-Models-Guide) |
| Use the quality tools | [Tools: Linter, Optimizer, Recommender](Tools-Linter-Optimizer-Recommender) |
| Build desktop apps | [Desktop Apps](Desktop-Apps) |
| Contribute | [Contributing](Contributing) |

---

**Navigation:** [← Home](Home) &nbsp;|&nbsp; [CLI Reference →](CLI-Reference)
