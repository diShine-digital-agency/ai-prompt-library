...
L'output viene generato in `dist/`. Consulta la pagina [App Desktop](App-Desktop) per le guide specifiche per piattaforma.
...
| Vuoi... | Vai a... |
|---------|----------|
| Imparare tutti i comandi CLI | [Riferimento CLI](Riferimento-CLI) |
| Esplorare lo strumento nel browser | [Prompt Workshop](Prompt-Workshop-IT) |
| Padroneggiare le tecniche di prompting | [Tecniche di Prompting](Tecniche-di-Prompting) |
| Confrontare i modelli AI | [Guida Modelli AI](Guida-Modelli-AI) |
| Usare gli strumenti di qualità | [Strumenti: Linter, Optimizer, Recommender](Strumenti-Linter-Optimizer-Recommender) |
| Compilare le app desktop | [App Desktop](App-Desktop) |
| Contribuire | [Contribuire](Contribuire) |

---

**Navigazione:** [← Home](Home-IT) &nbsp;|&nbsp; [Riferimento CLI →](Riferimento-CLI)
