...
| **Ignorare i punti di forza del modello** | Usare il modello sbagliato per il compito | Consulta la [Guida Modelli AI](Guida-Modelli-AI) |
...
4. Usa il [Prompt Linter](Strumenti-Linter-Optimizer-Recommender) per verificare i tuoi prompt
...
**Navigazione:** [← Prompt Workshop](Prompt-Workshop-IT) &nbsp;|&nbsp; [Guida Modelli AI →](Guida-Modelli-AI)
