...
| **Ignoring model strengths** | Using the wrong model for the task | See [AI Models Guide](AI-Models-Guide) |
...
4. Use the [Prompt Linter](Tools-Linter-Optimizer-Recommender) to check your prompts
...
**Navigation:** [← Prompt Workshop](Prompt-Workshop) &nbsp;|&nbsp; [AI Models Guide →](AI-Models-Guide)
